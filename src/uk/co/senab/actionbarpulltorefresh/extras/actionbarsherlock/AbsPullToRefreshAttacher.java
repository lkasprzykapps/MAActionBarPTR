...
import uk.co.senab.actionbarpulltorefresh.EnvironmentDelegate;
import uk.co.senab.actionbarpulltorefresh.HeaderTransformer;
import uk.co.senab.actionbarpulltorefresh.Options;
...
class AbsPullToRefreshAttacher extends uk.co.senab.actionbarpulltorefresh.PullToRefreshAttacher {
	...
	protected void addHeaderViewToActivity(View headerView) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			...
			// On older devices we need to wrap the HeaderView in a FrameLayout
			// otherwise
